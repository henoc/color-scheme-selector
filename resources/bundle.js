...
var _user$project$Utils$index = function (lst) {
	return A2(
		_elm_lang$core$List$range,
		0,
		_elm_lang$core$List$length(lst) - 1);
};
var _user$project$Utils$getAt = F2(
	function (lst, k) {
		getAt:
		while (true) {
			var _p0 = lst;
...
var _user$project$Utils$remove = F2(
	function (lst, k) {
		var _p1 = lst;
		if (_p1.ctor === '::') {
			var _p2 = _p1._1;
			return _elm_lang$core$Native_Utils.eq(k, 0) ? _p2 : {
				ctor: '::',
				_0: _p1._0,
				_1: A2(_user$project$Utils$remove, _p2, k - 1)
			};
		} else {
			return lst;
		}
	});
var _user$project$Utils$insert = F3(
	function (lst, k, item) {
		if (_elm_lang$core$Native_Utils.eq(k, 0)) {
			return {ctor: '::', _0: item, _1: lst};
		} else {
			var _p3 = lst;
			if (_p3.ctor === '::') {
				return {
					ctor: '::',
					_0: _p3._0,
					_1: A3(_user$project$Utils$insert, _p3._1, k - 1, item)
				};
			} else {
				return lst;
			}
...
var _user$project$Utils$replace = F3(
	function (lst, k, item) {
		var _p4 = lst;
		if (_p4.ctor === '::') {
			var _p5 = _p4._1;
			return _elm_lang$core$Native_Utils.eq(k, 0) ? {ctor: '::', _0: item, _1: _p5} : {
				ctor: '::',
				_0: _p4._0,
				_1: A3(_user$project$Utils$replace, _p5, k - 1, item)
			};
		} else {
			return lst;
		}
...
var _user$project$Main$model = {
	colors: {
		ctor: '::',
		_0: _elm_lang$core$Color$darkGray,
		_1: {
			ctor: '::',
	...
	viewColorPicker: _elm_lang$core$Maybe$Nothing
};
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {colors: a, mdl: b, colorPicker: c, viewColorPicker: d};
	});
var _user$project$Main$HideColorPicker = {ctor: 'HideColorPicker'};
var _user$project$Main$ViewColorPicker = function (a) {
	return {ctor: 'ViewColorPicker', _0: a};
};
var _user$project$Main$ColorPickerMsg = F2(
	function (a, b) {
		return {ctor: 'ColorPickerMsg', _0: a, _1: b};
	});
var _user$project$Main$RemoveColor = function (a) {
	return {ctor: 'RemoveColor', _0: a};
};
var _user$project$Main$InsertNewColor = F2(
	function (a, b) {
		return {ctor: 'InsertNewColor', _0: a, _1: b};
	});
var _user$project$Main$RollAll = {ctor: 'RollAll'};
var _user$project$Main$Roll = function (a) {
	return {ctor: 'Roll', _0: a};
};
var _user$project$Main$SetColor = F2(
	function (a, b) {
		return {ctor: 'SetColor', _0: a, _1: b};
	});
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p0.ctor) {
				...
				case 'Roll':
					return A2(
						...
						model,
						{
							...
							_0: A2(
								_elm_lang$core$Random$generate,
								_user$project$Main$SetColor(_p0._0),
								A4(
				...
				case 'RollAll':
					return A2(
						...
						A2(
							...
							_user$project$Utils$index(model.colors)));
				case 'SetColor':
					var newColors = A3(_user$project$Utils$replace, model.colors, _p0._0, _p0._1);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
						...
						{ctor: '[]'});
				case 'InsertNewColor':
					var newColors = A3(_user$project$Utils$insert, model.colors, _p0._0, _p0._1);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
						...
						{ctor: '[]'});
				case 'RemoveColor':
					var newColors = A2(_user$project$Utils$remove, model.colors, _p0._0);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'ColorPickerMsg':
					var _p4 = _p0._0;
					var defaultColor = A2(_user$project$Utils$getAt, model.colors, _p4);
					var _p1 = function () {
						var _p2 = defaultColor;
						if (_p2.ctor === 'Just') {
							return A3(_simonh1000$elm_colorpicker$ColorPicker$update, _p0._1, _p2._0, model.colorPicker);
						} else {
							return {ctor: '_Tuple2', _0: model.colorPicker, _1: _elm_lang$core$Maybe$Nothing};
						}
					}();
					var cp = _p1._0;
					var col = _p1._1;
					var _p3 = col;
					if (_p3.ctor === 'Just') {
						var _v3 = A2(_user$project$Main$SetColor, _p4, _p3._0),
							_v4 = model;
						msg = _v3;
						model = _v4;
						continue update;
				...
				case 'ViewColorPicker':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								viewColorPicker: _elm_lang$core$Maybe$Just(_p0._0)
							}),
						{ctor: '[]'});
				default:
					return A2(
...
var _user$project$Main$colorPanels = F2(
	function (model, counter) {
		var len = _elm_lang$core$List$length(model.colors);
		var loop = F3(
			function (colors, i, panelNo) {
				var _p5 = colors;
				if (_p5.ctor === '[]') {
					return {ctor: '[]'};
				} else {
					...
					return {
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_0: {
											...
											_1: A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(
													100.0 / _elm_lang$core$Basics$toFloat(len)),
												'%')
										},
										_1: {ctor: '[]'}
									}),
									...
									},
									{
										...
										_0: A5(
											...
											model.mdl,
											{
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$onClick(
													_user$project$Main$Roll(panelNo)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _debois$elm_mdl$Material_Icon$i('cached'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A5(
												...
												model.mdl,
												{
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onClick(
														A2(_user$project$Main$InsertNewColor, panelNo, _p7)),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
											...
											_1: {
												...
												_0: A5(
													...
													model.mdl,
													{
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onClick(
															_user$project$Main$RemoveColor(panelNo)),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_eskimoblood$elm_color_extra$Color_Convert$colorToHex(_p7)),
													_1: {ctor: '[]'}
												}
											}
										}
										...
										_elm_lang$html$Html$div,
										{
													...
													_1: {
														...
														_1: {
															...
															_0: {
																ctor: '_Tuple2',
																_0: 'background',
																_1: _eskimoblood$elm_color_extra$Color_Convert$colorToHex(_p7)
															},
															_1: {ctor: '[]'}
														}
													}
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Events$onMouseOver(
													_user$project$Main$ViewColorPicker(panelNo)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onMouseLeave(_user$project$Main$HideColorPicker),
													_1: {ctor: '[]'}
												}
											}
										},
										function () {
											var _p6 = model.viewColorPicker;
											if (_p6.ctor === 'Nothing') {
												return {ctor: '[]'};
											} else {
												return _elm_lang$core$Native_Utils.eq(_p6._0, panelNo) ? {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$map,
														_user$project$Main$ColorPickerMsg(panelNo),
														A2(_simonh1000$elm_colorpicker$ColorPicker$view, _p7, model.colorPicker)),
													_1: {ctor: '[]'}
												} : {ctor: '[]'};
											}
										}()),
						...
						_1: A3(loop, _p5._1, i + 4, panelNo + 1)
					};
				}
			});
		return A3(loop, model.colors, counter, 0);
	});
			...
			{ctor: '[]'},
			{
					...
					},
					{
						...
						_0: A5(
							...
							model.mdl,
							{
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$RollAll),
									_1: {ctor: '[]'}
								}
							},
							{
				...
				_1: {
					...
					_0: A2(
						...
						A2(_user$project$Main$colorPanels, model, 1)),
					_1: {ctor: '[]'}
				}
			}));
};
